...
public class PicUploadFileSystemService {
    ...
    public PicUploadResult upload(MultipartFile uploadFile) {
        ...
        //生成图片的绝对引用地址
        String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, "D:\\code\\itcast-haoke\\haoke-upload"), "\\", "/");
    ...
    private String getFilePath(String sourceFileName) {
        String baseFolder = "D:\\code\\itcast-haoke\\haoke-upload" + File.separator
                + "images";
